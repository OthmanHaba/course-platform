    ...
    public function run()
    {
        ...
        $reviews = [
            ...
            [
                ...
                'course_id' => 1,
                'rating' => 5,
                'review_text' => 'Excellent course! Very comprehensive and well-structured. I learned so much and feel confident building websites now.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 1,
                'rating' => 4,
                'review_text' => 'Great course overall. The instructor explains concepts clearly. Would have liked more advanced topics though.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 1,
                'rating' => 5,
                'review_text' => 'Best web development course I\'ve taken! Highly recommend for beginners.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 2,
                'rating' => 5,
                'review_text' => 'Amazing deep dive into Vue 3! The Composition API section was particularly helpful.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 3,
                'rating' => 4,
                'review_text' => 'Good course on React Native. Covers all the essentials. Some sections could be more in-depth.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 4,
                'rating' => 5,
                'review_text' => 'Perfect introduction to data science! The hands-on projects were really valuable.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 4,
                'rating' => 5,
                'review_text' => 'Excellent course for beginners. Clear explanations and practical examples.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 5,
                'rating' => 4,
                'review_text' => 'Comprehensive coverage of ML algorithms. Requires some math background but very rewarding.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 6,
                'rating' => 5,
                'review_text' => 'Love this course! I\'m now confident in creating user-friendly designs.',
                'is_approved' => 1,
                'created_at' => date('Y-m-d H:i:s', strtotime('-1 days')),
                'updated_at' => date('Y-m-d H:i:s', strtotime('-1 days')),
            ],
            [
                ...
                'course_id' => 6,
                'rating' => 4,
                'review_text' => 'Great introduction to UX principles. Would like more advanced prototyping techniques.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 7,
                'rating' => 4,
                'review_text' => 'Solid business fundamentals. The business plan template was very useful.',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 8,
                'rating' => 5,
                'review_text' => 'Exactly what I needed to start my marketing career. Practical and up-to-date!',
                'is_approved' => 1,
            ...
            [
                ...
                'course_id' => 2,
                'rating' => 3,
                'review_text' => 'The course is okay but moves too fast for intermediate level.',
                'is_approved' => 0,
