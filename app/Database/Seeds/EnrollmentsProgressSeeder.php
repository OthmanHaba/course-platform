    ...
    public function run()
    {
        ...
        $enrollments = [
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-2 days')),
                'completed_at' => null,
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-10 days')),
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-1 days')),
                'completed_at' => null,
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-5 days')),
                'completed_at' => null,
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-3 days')),
                'completed_at' => null,
            ...
            [
                ...
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-4 days')),
                'completed_at' => null,
            ...
            [
                ...
                'progress_percentage' => 100,
                'last_accessed' => date('Y-m-d H:i:s', strtotime('-15 days')),
        ...
        $progress = [
            ...
            // Alice's completed progress in Course 4
            ['user_id' => 5, 'lesson_id' => 14, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-44 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-44 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-44 days'))],
            ['user_id' => 5, 'lesson_id' => 15, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-40 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-40 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-40 days'))],
            ['user_id' => 5, 'lesson_id' => 16, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-35 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-35 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-35 days'))],
            ['user_id' => 5, 'lesson_id' => 17, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-30 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-30 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-30 days'))],
            ['user_id' => 5, 'lesson_id' => 18, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-25 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-25 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-25 days'))],
            ['user_id' => 5, 'lesson_id' => 19, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-20 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-20 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-20 days'))],
            ...
            // Emma's completed progress in Course 1
            ...
            ['user_id' => 9, 'lesson_id' => 12, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-18 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-18 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-18 days'))],
            ['user_id' => 9, 'lesson_id' => 13, 'is_completed' => 1, 'completed_at' => date('Y-m-d H:i:s', strtotime('-15 days')), 'created_at' => date('Y-m-d H:i:s', strtotime('-15 days')), 'updated_at' => date('Y-m-d H:i:s', strtotime('-15 days'))],
        ];
